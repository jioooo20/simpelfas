                                ...
                                <span>
                                    @php
                                        ...
                                        if ($selectedPerbaikan->perbaikan && $selectedPerbaikan->perbaikan->latestStatusPerbaikan) {
                                            $status = $selectedPerbaikan->perbaikan->latestStatusPerbaikan->perbaikan_status;
                                        } elseif ($selectedPerbaikan->statusPelaporan && $selectedPerbaikan->statusPelaporan->first()) {
                    ...
                    <div class="alert shadow-lg mb-6">
                        <div class="flex justify-between w-full">
                            <div>
                                ...
                                <div class="ml-2">
                                    <h3 class="font-bold">Kode Perbaikan: {{ $selectedPerbaikan->perbaikan->perbaikan_kode }}</h3>
                                    @php
                                        $status = 'Menunggu Penugasan';
                                    ...
                                    @endphp
                                    <div class="text-sm">Status: <span class="badge {{ $badgeClass }}">{{ $status }}</span></div>
                                </div>
                            </div>
                            <div>
                                <span class="text-sm">Dibuat: {{ $selectedPerbaikan->perbaikan->created_at->format('d/m/Y H:i') }}</span>
                            </div>
                        </div>
                    </div>
                @else
                    ...
                    <tbody>
                        ...
                        @foreach ($laporanFasilitas as $laporan)
                            <tr @if ($laporan->pelaporan_id == $selectedPerbaikan->pelaporan_id) class="bg-blue-50 font-bold" @endif>
                                <td>
                                    <span class="badge badge-outline">{{ $laporan->pelaporan_kode }}</span>
                                </td>
                                <td class="max-w-xs">
