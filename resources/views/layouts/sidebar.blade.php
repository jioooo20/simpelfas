    ...
    <nav class="flex-1">
        <ul class="space-y-2">
            ...
            @if (in_array(Auth::user()->role_id, ['2']))
                ...
                <li>
                    <a href="{{ route('sarpra.rekomendasi-prioritas-perbaikan') }}" class="flex items-center gap-4 p-2 rounded-md hover:bg-base-200 group">
                ...
                <li x-data="{ open: {{ $isSubmenuOpen ? 'true' : 'false' }} }" x-init="open = {{ $isSubmenuOpen ? 'true' : 'false' }}">
                    <a href="#" @click.prevent="open = !open"
                        class="flex items-center gap-4 p-2 rounded-md hover:bg-base-200 group">
                        <i
                            class="bi bi-bar-chart-fill text-gray-500 group-hover:text-primary text-lg w-6 text-center"></i>
                    ...
                    <ul x-show="open" x-cloak x-transition:enter="transition-all ease-out duration-300"
                        ...
                        <li>
                            <a href="{{ route('statistik-fasilitas') }}"
                                ...
                                <i
                                    class="bi bi-graph-up text-gray-500 group-hover:text-primary text-lg w-6 text-center"></i>
                        ...
                        <li>
                            <a href="{{ route('frekuensi-perbaikan') }}"
                                ...
                                <i
                                    class="bi bi-arrow-repeat text-gray-500 group-hover:text-primary text-lg w-6 text-center"></i>
                        ...
                        <li>
                            <a href="{{ route('kepuasan-pengguna') }}"
                                ...
                                <i
                                    class="bi bi-emoji-smile text-gray-500 group-hover:text-primary text-lg w-6 text-center"></i>
                        ...
                        <li>
                            <a href="{{ route('perencanaan-pemeliharaan') }}"
                                ...
                                <i
                                    class="bi bi-tools text-gray-500 group-hover:text-primary text-lg w-6 text-center"></i>
