{{-- sidebar --}}
<div id="sidebar"
    class="transition-all duration-300 bg-slate-800 text-white w-64 h-screen p-4 flex flex-col fixed top-0">
    ...
    <hr class="border-t border-2 border-slate-600 my-2">

    <nav class="flex-1">
        <ul class="space-y-2">
            <li>
                <a href="#" class="flex items-center gap-4 p-2 rounded-md hover:bg-slate-700 group">
            ...
            <li x-data="{ open: false }">
                <a href="#" @click="open = ! open"
                    class="flex items-center gap-4 p-2 rounded-md hover:bg-slate-700 group">
                    <i class="fa-solid fa-user group-hover:scale-110 transition-transform duration-200"></i>
                ...
                <ul x-show="open" class="space-y-2 mt-2 ml-6">
                    <li>
                        <a href="#" class="flex items-center gap-4 p-2 rounded-md hover:bg-slate-700 group">
                            <i
                                class="fa-solid fa-users-cog group-hover:scale-110 transition-transform duration-200"></i>
                            <span class="sidebar-text text-sm">Role</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="flex items-center gap-4 p-2 rounded-md hover:bg-slate-700 group">
                            <i
                                class="fa-solid fa-user-plus group-hover:scale-110 transition-transform duration-200"></i>
                            <span class="sidebar-text text-sm">User</span>
                        </a>
                    </li>
                </ul>
            </li>
            <li x-data="{ open: false }">
                <a href="#" @click="open = ! open"
                    class="flex items-center gap-4 p-2 rounded-md hover:bg-slate-700 group">
                    <i class="fa-solid fa-folder group-hover:scale-110 transition-transform duration-200"></i>
                ...
                <ul x-show="open" class="space-y-2 mt-2 ml-6">
                    <li>
                        <a href="#" class="flex items-center gap-4 p-2 rounded-md hover:bg-slate-700 group">
                            <i class="fa-solid fa-file-invoice group-hover:scale-110 transition-transform duration-200"></i>
            ...
            <li x-data="{ open: false }">
                <a href="#" @click="open = ! open"
                    class="flex items-center gap-4 p-2 rounded-md hover:bg-slate-700 group">
                    <i class="fa-solid fa-circle-exclamation group-hover:scale-110 transition-transform duration-200"></i>
                ...
                <ul x-show="open" class="space-y-2 mt-2 ml-6">
                    <li>
                        <a href="#" class="flex items-center gap-4 p-2 rounded-md hover:bg-slate-700 group">
                            <i class="fa-solid fa-file-contract group-hover:scale-110 transition-transform duration-200"></i>
                            <span class="sidebar-text text-sm">Laporan Kerusakan</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="flex items-center gap-4 p-2 rounded-md hover:bg-slate-700 group">
                            <i class="fa-solid fa-chart-simple group-hover:scale-110 transition-transform duration-200"></i>
            ...
            <li>
                <a href="#" class="flex items-center gap-4 p-2 rounded-md hover:bg-slate-700 group">
                    <i class="fa-solid fa-calendar-days group-hover:scale-110 transition-transform duration-200"></i>
            ...
            <li>
                <a href="{{ route('keluar') }}"
                    class="flex items-center gap-4 p-2 rounded-md hover:bg-slate-700 text-red-500 group"
