...
<body>
    <div class="flex min-h-screen bg-indigo-50">
        ...
        <div class="hidden lg:flex lg:w-1/2 bg-indigo-100 items-center justify-center p-12">
            <img src="{{ asset('landing.png') }}" alt="Login vector image" class="max-w-full h-auto object-contain">
        </div>

        <!-- Right side - Login Form -->
        <div class="w-full lg:w-1/2 flex flex-col justify-center py-12 px-6 sm:px-12">
            <div class="sm:mx-auto sm:w-full sm:max-w-md">
                <h1 class="text-center text-4xl font-extrabold text-indigo-700 mb-4 judul">Simpelfas</h1>
            ...
            <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                <div class="bg-white py-8 px-6 shadow-lg rounded-xl sm:px-10">
                    <form class="space-y-6" action="{{ route('postlogin') }}" method="POST" id="loginForm">
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative">
                                ...
                                <input id="username" name="username" type="text" autocomplete="username" required
                                    ...
                                    class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm pl-10 py-2.5 placeholder-gray-400 transition">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative">
                                ...
                                <input id="password" name="password" type="password" autocomplete="current-password"
                                    ...
                                    class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm pl-10 pr-10 py-2.5 placeholder-gray-400 transition">
                        ...
                        <div class="mt-4">
                            <button type="submit"
                                class="flex items-center justify-center w-full gap-2 rounded-md bg-indigo-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition">
