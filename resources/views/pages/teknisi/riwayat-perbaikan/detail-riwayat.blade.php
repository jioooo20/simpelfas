...
@section('content')
    <div class="container mx-auto px-4 py-4">
            ...
            <div class="card bg-base-100 shadow-xl">
                <div class="card-body">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="mb-3">
                            <span class="font-semibold">Tanggal Dilaporkan:</span>
                            <p>19/05/2025 09:30</p>
                        </div>

                        <div class="mb-3">
                            <span class="font-semibold">Tanggal Selesai:</span>
                            <p>21/05/2025 14:35</p>
                        </div>

                        <div class="mb-3">
                            <span class="font-semibold">Durasi Perbaikan:</span>
                            <p>2 hari 5 jam 5 menit</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="mb-3">
                            ...
                            <p class="text-sm">Penggantian lampu proyektor dengan komponen baru. Melakukan pembersihan lensa dan filter udara yang kotor. Testing selama 1 jam menunjukkan kinerja normal.</p>
                        </div>

                        <div class="mb-3">
                            <span class="font-semibold">Komponen yang Diganti:</span>
                            <p>Lampu Proyektor Sony LMP-E221</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="card bg-base-100 shadow-lg">
                    <figure class="px-4 pt-4">
                        <img src="https://via.placeholder.com/400x300?text=Foto+Kerusakan" alt="Foto Saat Dilaporkan" 
                ...
                <div class="card bg-base-100 shadow-lg">
                    <figure class="px-4 pt-4">
                        <img src="https://via.placeholder.com/400x300?text=Foto+Proses+Perbaikan" alt="Foto Saat Perbaikan" 
                            class="rounded-lg h-48 w-full object-cover cursor-pointer"
                ...
                <div class="card bg-base-100 shadow-lg">
                    <figure class="px-4 pt-4">
                        <img src="https://via.placeholder.com/400x300?text=Foto+Setelah+Perbaikan" alt="Foto Setelah Perbaikan" 
                            class="rounded-lg h-48 w-full object-cover cursor-pointer"
        ...
        <div class="mt-6 flex justify-end">
            <a href="{{ route('teknisi.riwayat-perbaikan') }}" class="btn btn-outline">
    ...
    <dialog id="image_modal" class="modal modal-bottom sm:modal-middle">
        <div class="modal-box max-w-3xl">
            ...
            <div class="flex justify-center">
                <img id="modal-image" src="" alt="Preview" class="max-h-96 rounded-lg">
            </div>
