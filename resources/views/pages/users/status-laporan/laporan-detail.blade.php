...
@section('content')
    <div class="p-4">
        ...
        <!-- Gambar Container -->
        <div id="image-container" class="mt-6 grid grid-cols-3 gap-4 scroll-mt-20"></div> <!-- End of Gambar Container -->
