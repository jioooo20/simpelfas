...
@section('content')
                    ...
                    <div class="p-6">
                        <div class="flex flex-col md:flex-row gap-6">
                            ...
                            <div class="w-full md:w-48 flex-shrink-0 relative">
                                ...
                                <!-- Status badge -->
                                @php
                                    $statusHistory = \App\Models\StatusPelaporanModel::where(
                                        'pelaporan_id',
                                        $items->pelaporan_id,
                                    )
                                        ->orderBy('created_at')
    ...
    {{ $items->fasilitas->barang->barang_nama ?? 'Unknown' }} - {{ substr($items->pelaporan_kode, -2) }}
</h3>
                                ...
                                <div class="flex justify-end">
                                    @if ($items->feedback)
    <a href="{{ route('feedback-detail', $items->pelaporan_id) }}"
                                            ...
                                            <i class="bi bi-eye-fill mr-1"></i> Detail Penilaian
                                        </a>
                                    @else
                                        <a href="{{ route('feedback-create', ['perbaikan_id' => $items->pelaporan_id]) }}"
                                            ...
                                            <i class="bi bi-star-fill mr-1"></i> Beri Penilaian
                                        </a>
                                    @endif
                                </div>
                            </div>
